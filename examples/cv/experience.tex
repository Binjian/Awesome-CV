...
\begin{cventries}
	...
	%---------------------------------------------------------
	\cventry
	{Technical Expert, Deep Reinforcement Learning} % Job title
	{Siasun Robot, Shanghai Research Institute} % Organization
	{Shanghai, China} % Location
	{Nov. 2024 - } % Date(s)
	{
		\begin{cvitems}
			\item Development of reinforcement learning algorithms for humanoid robot gait and manipulator control
			\item Robot 3D semantics and SLAM
		\end{cvitems}
	}
