...
\begin{cventries}
	...
	{
		\begin{cvitems}
			\item Locomotion simulation and reinforcement learning algorithm development for embodied robots
			\begin{itemize}
			...
			\end{itemize}
			\item Reinforcement learning applications integrating system dynamics
			\begin{itemize}
				\item Integrated multibody, thermal, electrical, fluid, and mechanical simulation for welding robots, with visualization and data-driven system identification $\rightarrow$ \textbf{welding-dynamics} \href{https://gitlab.com/siasunx1/welding-dynamics/}{\faGitlab}
				\item Data-driven system identification of coupled multibody, thermal, and friction dynamics in gear reducers $\rightarrow$ \textbf{gear-reducer} \href{https://gitlab.com/siasunx1/gear-reducer/}{\faGitlab}
			...
			\begin{itemize}
				...
				\item Programming assistant (Copilot): syntax parsing for robot programming languages, virtual interpreter development, and functional code generation $\rightarrow$ \textbf{llm-backend} \href{https://gitlab.com/siasunx1/llm-backend}{\faGitlab}
