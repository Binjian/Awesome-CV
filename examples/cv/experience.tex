...
\begin{cventries}
	...
	%---------------------------------------------------------
	\cventry
	{Technical Expert, Reinforcement Learning} % Job title
	{SIASUN Robotics Shanghai Research Institute} % Organization
	{Shanghai, China} % Location
	{Nov. 2024 - } % Date(s)
	{
		\begin{cvitems}
			\item Simulation and reinforcement learning traiining of humanoid robots
			\begin{itemize}
				\item Biped robot modeling, reinforcement learning training in simulation, and sim-to-real transfer
				\item Multibody dynamics simulation and system identification
			\end{itemize}
			\item Reinforcement learning applications with system dynamics
			\begin{itemize}
				\item Coupled multibody, thermal, electrical, fluid, and mechanical simulation for welding robots, visualization and data-driven system identification $\rightarrow$ \textbf{welding-dynamics} \href{https://gitlab.com/siasunx1/welding-dynamics/}{\faGitlab}
				\item Data-driven system identification coupling multibody, thermal, and friction dynamics in gear reducers $\rightarrow$ \textbf{gear-reducer} \href{https://gitlab.com/siasunx1/gear-reducer/}{\faGitlab}
				\item Multibody and electromagnetic dynamics simulation and data-driven predictive maintenance algorithms for servo joint modules $\rightarrow$ \textbf{servo-gear-motor} \href{https://gitlab.com/siasunx1/servo-gear-motor/}{\faGitlab}
			\end{itemize}
			\item Large language model application development and deployment
			\begin{itemize}
				\item Retrieval-augmented generation (RAG) $\rightarrow$ \textbf{ribosome} \href{https://gitlab.com/Binjian/ribosome}{\faGitlab}
				\item Coding assistant (Copilot): syntax parsing for robot programming languages, virtual interpreter development, and functional code generation $\rightarrow$ \textbf{llm-backend} \href{https://gitlab.com/siasunx1/llm-backend}{\faGitlab}
        \item Agentic code generation with formal verification $\rightarrow$ \textbf{aligned} \href{https://gitlab.com/Binjian/aligned}{\faGitlab}
				\item Backend development and maintenance for a RAG-enabled WeChat Mini Program
				\item PDF OCR, translation, semantic analysis, and knowledge graph generation $\rightarrow$ \textbf{pdfmathtranslate} \href{https://gitlab.com/siasunx1/pdfmathtranslate}{\faGitlab}
			\end{itemize}
		\end{cvitems}
	}
