...
\begin{cventries}
	...
	{2020年11月 - 2024年5月} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			...
			\begin{itemize}
				\item 基于自然语言接口和LLM的自动驾驶决策系统 \supercite{Xin_LLM_24}
				\item 基于自然语言接口和多模态基础模型VLM的自动驾驶决策系统 \supercite{Xin_VLM_24}
				\item 基于隐空间扩散模型的图像复原\supercite{Xin_Latent_Diffusion_23}
				\item NERF及Gaussian Splatting场景三维建模
			\end{itemize}
		\end{cvitems}
	}
