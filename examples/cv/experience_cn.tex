...
\begin{cventries}
	...
	{
		\begin{cvitems}
			\item 具身智能机器人行走仿真与强化学习算法开发
			\begin{itemize}
        \item 两足机器人建模和强化学习仿真训练与迁移
				\item 多体动力学仿真和系统识别
			\end{itemize}
			\item 集成系统动力学的强化学习应用
			\begin{itemize}
        \item 焊接机器人多体/热/电/流体/动力学一体仿真,可视化与数据驱动系统识别 $\rightarrow$ \textbf{welding-dynamics} \href{https://gitlab.com/siasunx1/welding-dynamics/}{\faGitlab}
				\item 减速机热摩擦耦合多体/热/摩擦基于数据驱动的系统识别 $\rightarrow$ \textbf{gear-reducer} \href{https://gitlab.com/siasunx1/gear-reducer/}{\faGitlab}
        \item 关节模组伺服系统多体/电磁动力学仿真和数据驱动的预测性维护算法应用 $\rightarrow$ \textbf{servo-gear-motor} \href{https://gitlab.com/siasunx1/servo-gear-motor/}{\faGitlab}
			\end{itemize}
			\item 大语言模型应用开发和部署
			\begin{itemize}
				\item 检索增强生成(RAG) $\rightarrow$ \textbf{ribosome} \href{https://gitlab.com/Binjian/ribosome}{\faGitlab}
        \item 编程助手(Copilot): 机器人编程语言语法解析,虚拟解释器,功能代码生成 $\rightarrow$ \textbf{llm-backend} \href{https://gitlab.com/siasunx1/llm-backend}{\faGitlab}
        \item 结合形式验证的智能体编程 $\rightarrow$ \textbf{aligned} \href{https://gitlab.com/Binjian/aligned}{\faGitlab}
        \item RAG微信小程序后端开发及维护
        \item pdf文档OCR,翻译,语义分析和知识图谱生成  $\rightarrow$ \textbf{pdfmathtranslate} \href{https://gitlab.com/siasunx1/pdfmathtranslate}{\faGitlab}
			\end{itemize}
		\end{cvitems}
	}
	...
	{2020年11月 - 2024年5月} % Date(s)
	{
		\begin{cvitems} % Description(s) of tasks/responsibilities
			\item 基于深度强化学习的运动规划(能效提升20\%) \supercite{xin2026ieee} \supercite{Xin_VEOS_22} \supercite{Xin_Fu_Pan_Simulation_Test_RL_22} \supercite{Pan_Xin_DrvStyle_23}，
			\begin{itemize}
				...
				\item 基于时间序列的深度强化学习应用软件(ETL与ML协同异步管道架构设计实现) $\rightarrow$ \textbf{tspace} \href{https://binjian.github.io/tspace/}{\faGithub}，
			...
			\begin{itemize}
				...
				\item 基于生成模型的时间序列分析应用软件 $\rightarrow$ \textbf{funes-ts} \href{https://github.com/binjian/funes-ts/}{\faGithub}。
				\item 基于基础模型的时间序列预测
				\item 模型蒸馏与数据蒸馏
			\end{itemize}
			\pagebreak
