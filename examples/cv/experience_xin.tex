  ...
  \cventry
    ...
    {Nov. 2020 - May 2024} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
          \item Reinforcemnt learning based electric powertrain control optimization in multi-modal complex environments
          \hyperlink{Xin_VEOS_22}{$\rightarrow$\circled{P}1} \hyperlink{Xin_Fu_Pan_Simulation_Test_RL_22}{\circled{P}2} \hyperlink{Pan_Xin_DrvStyle_23}{\circled{P}3}.
          \item Time series anomaly detection and battery state of safety prediction based on generative models. \hyperlink{Xin_GenAI_23}{$\rightarrow$\circled{P}4} \hyperlink{Xin_Chen_NN_TSFeatures_23}{\circled{P}5}
          \item Software design \& development of streaming data pipeline for time sequence analysis.
            \begin{itemize}
                    \item Data Flow (ETL, Deep Learning Training/Inference pipelines) \href{https://binjian.github.io/tspace/}{$\rightarrow$ \textbf{tspace}}.
