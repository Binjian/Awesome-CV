...
%---------------------------------------------------------
  \cventry
    ...
    {Newrizon Inc.} % Organization
    {Shanghai, China} % Location
    {Nov. 2020 - May 2024} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
          \item RL based electric powertrain control optimization in multi-modal complex environments.
          \hyperlink{Xin_VEOS_22}{$\rightarrow$\circled{P}} \hyperlink{Xin_Fu_Pan_Simulation_Test_RL_22}{$\rightarrow$\circled{P}} \hyperlink{Pan_Xin_DrvStyle_23}{$\rightarrow$\circled{P}}
          \item Time series anomaly detection and battery state of safety prediction based on generative models. \hyperlink{Xin_GenAI_23}{$\rightarrow$\circled{P}} \hyperlink{Xin_Chen_NN_TSFeatures_23}{$\rightarrow$\circled{P}}
          \item Software design \& development of streaming data pipeline for time sequence analysis.
            \begin{itemize}
                    \item Data Flow (ETL, ML training/inference pipelines) \href{https://binjian.github.io/tspace/}{$\rightarrow$ \textbf{tspace} }
                    \item CAN Application Python bundle \href{https://binjian.github.io/candycan/}{$\rightarrow$ \textbf{candycan}}
