...
%---------------------------------------------------------
  \cventry
    {Senior Technical Director, Advanced Research} % Job title
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems}
        \item Advanced hardware and software design of L4 autonomous driving system, in particular in perception software stack (vision \& lidar processing)
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems}
        \item Development of video based ADAS system, surround and rear view system, vision based object detection.
