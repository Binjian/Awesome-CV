  ...
  \cventry
    ...
    {Nov. 2020 - May 2024} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
          ...
          \item Time series anomaly detection and battery state of safety prediction based on generative models.
          \item Application of multimodal foundation model and large language model in autonomous driving.
