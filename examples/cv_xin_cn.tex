...
\documentclass[11pt, a4paper]{awesome-cncv}
...
%-------------------------------------------------------------------------------
\subfile{cv/education_xin_cn.tex}
\subfile{cv/experience_xin_cn.tex}
\subfile{cv/skills_xin_cn.tex}
...
% 子章节标题
%-------------------------------------------------------------------------------
\cvsubsection{\circled{J}ournal Articles}
...
% 子章节标题
%-------------------------------------------------------------------------------
\cvsubsection{\circled{C}onference Proceedings}
